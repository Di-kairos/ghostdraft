> **📦 Переехали:** разработка продолжается в [монорепозитории paranoid-tools](https://github.com/Di-kairos/paranoid-tools) (каталог `ghostdraft/`, история сохранена). Этот репозиторий в архиве: опубликованные релизы скачиваются, установщики работают, но issues, PR и новые релизы — в монорепозитории.
