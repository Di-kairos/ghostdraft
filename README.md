> **📦 Moved:** development continues in the [paranoid-tools monorepo](https://github.com/Di-kairos/paranoid-tools) (`ghostdraft/` directory, full history preserved). This repository is archived: its published releases stay downloadable and the installers keep working, but new issues, PRs and releases happen in the monorepo.
